...
package com.xpg.hssy.zxing.camera;
...
public final class CameraManager {
	...
	private static int MAX_FRAME_WIDTH = 2400;
	private static int MAX_FRAME_HEIGHT = 2400;
	...
	public void setIsTurnLight(boolean isTurnLight) {
		this.isTurnLight = isTurnLight;
	}

	private boolean isTurnLight = false ;//开关闪光灯
