 ...
 */
@SuppressLint("NewApi")
public class MyOrderAll extends BaseFragment implements IAppointOperatable, IMyOrderOperater, ItemForNoneOrderLayoutOperater {
...
//                intent.putExtra("order", order);
	...
	private void loadOrders(int start, int end) {
		...
		if (user_id != null && !"".equals(user_id)) {
			WebAPIManager.getInstance().getMyOrder(user_id, null, actionTypes, orders.size(), MyConstant.PAGE_SIZE, start, end, new
					WebResponseHandler<List<ChargeOrder>>(getActivity()) {
				@Override
				public void onStart() {
					super.onStart();
