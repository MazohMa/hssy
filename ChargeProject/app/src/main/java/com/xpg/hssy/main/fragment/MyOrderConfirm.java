 ...
 */
@SuppressLint("NewApi")
public class MyOrderConfirm extends BaseFragment implements IAppointOperatable,IMyOrderOperater,ItemForNoneOrderLayoutOperater {
    ...
    public MyOrderConfirm() {
    }

    @Override
    public void setUserVisibleHint(boolean isVisibleToUser) {
        super.setUserVisibleHint(isVisibleToUser);
//		Log.i("MyOrderConfirm == setUserVisibleHint", isVisibleToUser + "") ;
        if (isVisibleToUser) {
            if (orders.size() != 0) {
...
//                intent.putExtra("order", order);
    ...
    private void loadOrders(int start, int end) {
        ...
        actionTypes.add(ChargeOrder.ACTION_WATTING);
        actionTypes.add(ChargeOrder.ACTION_CONFIRM);
