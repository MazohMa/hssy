...
public class DatePickDialog extends Dialog implements OnClickListener,
		OnWheelChangedListener {

	private static final int START_YEAR = 2015;

	public static interface OnChangedListener {
		void onChanged(DatePickDialog tpd, int newYear, int newMonth,
				int newDay, int oldYear, int oldMonth, int oldDay);
	}

	public static interface OnOkListener {
		void onOk(DatePickDialog tpd, int year, int month, int day);
	}
	...
	private void init(Context context) {
		...
		nwaYear.setTextColor(context.getResources().getColor(R.color.white));
		nwaMonth.setTextColor(context.getResources().getColor(R.color.white));
		nwaDay28.setTextColor(context.getResources().getColor(R.color.white));
		nwaDay29.setTextColor(context.getResources().getColor(R.color.white));
		nwaDay30.setTextColor(context.getResources().getColor(R.color.white));
		nwaDay31.setTextColor(context.getResources().getColor(R.color.white));
		nwaYear.setTextColorUnselect(context.getResources().getColor(
				R.color.text_green_gray));
