...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	// Text settings
	private int textColorUnselect = DEFAULT_TEXT_COLOR;
			...
			if (textView != null) {
				...
				if (itemResourceId == TEXT_VIEW_ITEM_RESOURCE) {
					configureTextView(textView,
							index == currentItem ? textColor
									: textColorUnselect);
				} else {
					textView.setTextColor(index == currentItem ? textColor
							: textColorUnselect);
				}
			}
			return convertView;
	...
	public View getEmptyItem(View convertView, ViewGroup parent) {
		...
		if (emptyItemResourceId == TEXT_VIEW_ITEM_RESOURCE
			...
			configureTextView((TextView) convertView, textColorUnselect);
		}
	 ...
	 */
	protected void configureTextView(TextView view, int color) {
	...
	public void setCurrentItem(int currentItem) {
		...
		TextView oldTv = textViews.get(this.currentItem);
		if (oldTv != null)
			oldTv.setTextColor(textColorUnselect);

		TextView newTv = textViews.get(currentItem);
		if (newTv != null)
			newTv.setTextColor(textColor);
